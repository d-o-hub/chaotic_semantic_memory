...
/// AVX2-optimized bit-sliced bundling for a single 256-bit block (2 x u128 words).
...
/// AVX2-optimized bit-sliced bundling for a single 256-bit block (4 x u64 words).
#[cfg(all(not(target_arch = "wasm32"), target_arch = "x86_64"))]
#[inline]
#[target_feature(enable = "avx2")]
/// # SAFETY
/// Caller must ensure AVX2 is supported.
pub(crate) unsafe fn bundle_block_avx2_single_u64(
    vectors: &[&crate::hyperdim_binary::BHVec10240],
    word_idx: usize,
    threshold: usize,
    num_planes: usize,
) -> std::arch::x86_64::__m256i {
...
/// AVX2-optimized bundling for [u64; 160] binary hypervectors (`BHVec10240`).
#[cfg(all(not(target_arch = "wasm32"), target_arch = "x86_64"))]
/// # SAFETY
/// Caller must ensure AVX2 is supported.
pub(crate) unsafe fn bundle_block_avx2_u64(
    vectors: &[&crate::hyperdim_binary::BHVec10240],
    threshold: usize,
    num_planes: usize,
) -> [u64; 160] {
    ...
    for i in (0..160).step_by(4) {
        ...
        let res = unsafe { bundle_block_avx2_single_u64(vectors, i, threshold, num_planes) };
...
/// ARM NEON-optimized bit-sliced bundling for a single 128-bit block (2 x u64 words).
#[cfg(all(not(target_arch = "wasm32"), target_arch = "aarch64"))]
#[inline]
#[target_feature(enable = "neon")]
/// # SAFETY
/// Caller must ensure NEON is supported.
pub(crate) unsafe fn bundle_block_neon_single_u64(
    vectors: &[&crate::hyperdim_binary::BHVec10240],
    word_idx: usize,
    threshold: usize,
    num_planes: usize,
...
/// ARM NEON-optimized bundling for [u64; 160] binary hypervectors (`BHVec10240`).
#[cfg(all(not(target_arch = "wasm32"), target_arch = "aarch64"))]
/// # SAFETY
/// Caller must ensure NEON is supported.
pub(crate) unsafe fn bundle_block_neon_u64(
    vectors: &[&crate::hyperdim_binary::BHVec10240],
    threshold: usize,
    num_planes: usize,
) -> [u64; 160] {
    ...
    for i in (0..160).step_by(2) {
        ...
        let res = unsafe { bundle_block_neon_single_u64(vectors, i, threshold, num_planes) };
