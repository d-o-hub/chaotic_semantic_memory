...
use crate::retrieval_stub::graph_traversal::TraversalConfig;
...
pub struct ChaoticSemanticFramework {
    ...
    pub(crate) embedding_provider: Arc<dyn csm_embedding::EmbeddingProvider>,
    /// Random projection layer for embedding → HVec mapping.
    pub(crate) projection: Arc<csm_embedding::Projection>,
}
...
impl ChaoticSemanticFramework {
    ...
    pub async fn process_sequence(&self, sequence: &[Vec<f32>]) -> Result<HVec10240> {
        ...
        let r = reservoir_guard
            .as_mut()
            .ok_or(csm_core::MemoryError::reservoir(
