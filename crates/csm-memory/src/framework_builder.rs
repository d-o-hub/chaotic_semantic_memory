...
pub struct FrameworkConfig {
    ...
    pub index_backend: crate::retrieval_stub::index::IndexBackend,
...
impl Default for FrameworkConfig {
    fn default() -> Self {
        Self {
            ...
            index_backend: crate::retrieval_stub::index::IndexBackend::BruteForce,
...
pub struct FrameworkBuilder {
    ...
    pub(crate) embedding_provider: Option<Arc<dyn csm_embedding::EmbeddingProvider>>,
...
impl FrameworkBuilder {
    ...
    pub const fn with_index_backend(mut self, backend: crate::retrieval_stub::index::IndexBackend) -> Self {
    ...
    pub fn with_embedding_provider<P: csm_embedding::EmbeddingProvider + 'static>(
        mut self,
        provider: P,
    ) -> Self {
    ...
    pub fn with_embedding_provider_arc(
        mut self,
        provider: Arc<dyn csm_embedding::EmbeddingProvider>,
    ) -> Self {
    ...
    pub async fn build(self) -> Result<ChaoticSemanticFramework> {
        ...
        #[cfg(not(feature = "persistence"))]
        let persistence: Option<Arc<dyn Persistence>> = None;

        let provider = self
            .embedding_provider
            .unwrap_or_else(|| Arc::new(csm_embedding::HdcTextProvider::new()));

        let projection = if provider.name() == "hdc-text" {
            csm_embedding::Projection::empty()
        } else {
            csm_embedding::Projection::new(&csm_embedding::ProjectionConfig {
