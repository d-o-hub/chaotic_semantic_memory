...
impl<H: Hypervector> LshIndex<H> {
    ...
    /// Computes table hash directly from a pre-serialized hypervector byte slice.
    /// Memory Optimization: Avoids re-allocating 1280-byte byte slices per table evaluation.
