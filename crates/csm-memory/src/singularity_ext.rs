...
mod tests {
    ...
    #[test]
    fn test_bundle_concepts_strict_success() -> csm_core::Result<()> {
    ...
    #[test]
    fn test_bundle_concepts_strict_missing_id() -> csm_core::Result<()> {
        let mut singularity = Singularity::with_config(SingularityConfig::default());
        let vec1 = HVec10240::random();
    ...
    #[test]
    fn test_update_metadata_success() -> csm_core::Result<()> {
        let mut sing = Singularity::new(SingularityConfig::default());
