...
mod tests {
    ...
    use super::*;
    use csm_memory::semantic_bridge::CanonicalConcept;
    use csm_memory::singularity::{Singularity, SingularityConfig};
    ...
    fn test_bridge_retrieval_empty_graph() {
        ...
        let concept = csm_memory::singularity::ConceptBuilder::new("test-concept")
    ...
    fn test_bridge_retrieval_with_expansion() {
        ...
        let mut singularity = Singularity::new(SingularityConfig::default());
        let concept = csm_memory::singularity::ConceptBuilder::new("mem-1")
...
mod tests_v2 {
    use super::*;
    use csm_core::hyperdim::HVec10240;
    use csm_memory::singularity::{ConceptBuilder, Singularity, SingularityConfig};
