...
impl Singularity {
    ...
    pub fn bfs(
        ...
        csm_memory::framework::ChaoticSemanticFramework::validate_traversal_config(config)?;
        let ns_state = self
            .get_namespace(ns)
...
mod tests {
    ...
    use csm_memory::singularity::{Concept, ConceptBuilder, Singularity, SingularityConfig};
