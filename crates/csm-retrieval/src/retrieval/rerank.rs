...
impl Reranker for RecencyDecayReranker {
    ...
    fn rerank(
        ...
        let now = csm_memory::singularity::unix_now_secs();
...
pub fn parse_rerankers(s: &str) -> csm_core::Result<Vec<Box<dyn Reranker>>> {
        ...
        match name {
            "mmr" => {
                let lambda =
                    value
                        .parse::<f32>()
                        .map_err(|_| csm_core::MemoryError::InvalidInput {
            ...
            "recency" => {
                ...
                let half_life = val_str.parse::<f32>().map_err(|_| {
                    csm_core::MemoryError::InvalidInput {
                        field: "rerank".to_string(),
...
mod tests {
    ...
    fn test_parse_rerankers_windows_path() {
        ...
        if let csm_core::MemoryError::InvalidInput { reason, .. } = err {
