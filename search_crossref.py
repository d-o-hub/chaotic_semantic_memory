...
def search_crossref(query):
    ...
    # Since we don't have an api key, we should provide an email in the mailto parameter
    # But it's not strictly required for small queries
