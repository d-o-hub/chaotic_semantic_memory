...
impl MemoryHandler {
    async fn handle_memory_inject(&self, arguments: serde_json::Value) -> Result<CallToolResult, ErrorData> {
    ...
    async fn handle_memory_inject_text(&self, arguments: serde_json::Value) -> Result<CallToolResult, ErrorData> {
    ...
    async fn handle_memory_probe(&self, arguments: serde_json::Value) -> Result<CallToolResult, ErrorData> {
    ...
    async fn handle_memory_probe_text(&self, arguments: serde_json::Value) -> Result<CallToolResult, ErrorData> {
    ...
    async fn handle_memory_probe_filtered(&self, arguments: serde_json::Value) -> Result<CallToolResult, ErrorData> {
    ...
    async fn handle_memory_get(&self, arguments: serde_json::Value) -> Result<CallToolResult, ErrorData> {
    ...
    async fn handle_memory_delete(&self, arguments: serde_json::Value) -> Result<CallToolResult, ErrorData> {
    ...
    async fn handle_memory_associate(&self, arguments: serde_json::Value) -> Result<CallToolResult, ErrorData> {
    ...
    async fn handle_memory_traverse(&self, arguments: serde_json::Value) -> Result<CallToolResult, ErrorData> {
    ...
    async fn handle_memory_shortest_path(&self, arguments: serde_json::Value) -> Result<CallToolResult, ErrorData> {
    ...
    async fn handle_memory_stats(&self, _arguments: serde_json::Value) -> Result<CallToolResult, ErrorData> {
    ...
    async fn handle_memory_export(&self, arguments: serde_json::Value) -> Result<CallToolResult, ErrorData> {
